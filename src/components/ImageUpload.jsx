...
// export default function wMapUploadWithCheckpoints() {
...
//     // serverga yuborish uchun file-ni alohida saqlaymiz
...
//     try {
//       // ✅ local validation
//       const cardNumbers = checkpoints.map((cp) => cp.card_number);
//       const duplicates = cardNumbers.filter(
//         (cn, idx) => cardNumbers.indexOf(cn) !== idx
//       );
//       if (duplicates.length > 0) {
//         return message.error(
//           `Duplicate card_number topildi: ${duplicates[0]} ❌`
//         );
//       }
...
//   // 🚩 checkpoint qo‘shish (create & editda)
...
//           >
//             <img src={image} alt="map" className="max-w-lg rounded-xl" />
...
//                   min={1}
//                   value={cp.order}
//                   onChange={(val) => handleChange(i, "order", val)}
//                   addonBefore="Order"
//                   style={{ width: "200px" }}
//                 />
...
//                 {/* ✅ Yangi qo‘shilgan card_number input */}
//                 <Input
//                   placeholder="Card number"
//                   value={cp.card_number}
//                   onChange={(e) =>
